...
app.post('/davinci', async (req, res) => {
  ...
  try {
    ...
    const response = await openai.createChatCompletion({
      model: 'gpt-3.5-turbo',
      messages: [
        {"role": "system", "content": "you're an a AI assistant called 'ZZ Open Chat' that replies to all my questions in markdown format."},
        {"role": "user", "content": "hi"},
        {"role": "assistant", "content": "Hi I am ZZ Open Chat! How can I help you?"},
